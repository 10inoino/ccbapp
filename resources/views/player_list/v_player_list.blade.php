<?php
    ...
    $player_names = [
        ...
        ['山田 航希','yamada','Kouki Yamada','#12','PG','大学4年生。NEXUS研修生。高校時代は名門校、土浦日大高校の一員として活躍。八村塁に勝った男。卓越したボールハンドリングと、しなやかなドライブ、視野の広さから生まれるアシストを武器する。自分で点数を取れるし、仲間を活かすこともできる両刀ガード。'],
        ...
        ['佐藤 丈太郎','jo','Jotaro Sato','#18','C','社会人2年目。しがく山本主任担当。不動産営業。ペルーと日本のハーフで、ミドルネームはファビオ。190cmの身長を活かしたポストアップの他、ミドルレンジからシュート、ドライブと多彩なオフェンススキルを持つ。日本の3×3のリーグである、SOMECITYにも出場経験あり。サムネイルの写真は加工している訳では無いらしい。彼女募集中。タイプはロリ、フェミニストである。（本人談）'],
        ...
        ['佐藤 悠希','yuki','Yuki Sato','#14','C','社会人2年目。しがく岩村さん担当。学校の先生。決して派手なプレーをするわけではないが、粘り強いリバウンドと安定したミドルシュートでチームに貢献し続ける仕事人。玄人好みのロールプレイヤー。'],
        ['加藤 徹','tetsu','Tetsu Kato','','PF','大学4年生。NEXUS添田さん担当。今年からキャリアバスケ部に参画し、リバウンドやルーズボールでチームに貢献。目立つプレーはあまり無いが、試合出場中は粘り強くボールを追い続け、ベンチでもチームを盛り上げる。チームに熱を与えるプレイヤー。'],
        ['河村 龍樹','ryuki','Ryuki Kawamura','','SG','大学4年生。NEXUS菅野さん担当。3ポイントシュートを得意とするシューター。安定したシュートフォームから放たれる3ポイントシュートは、スラムダンクの三井寿を彷彿とさせる。ポイントガードとして起用されることもあり、良きロールプレイヤーとなっている。'],
        ['金澤 啓太','keita','Keita Kanazawa','','PG/SG','社会人1年目。キャリアコンサルティングNEXUS事業部社員。得意技はエナジャイズ。常に声を出し続け、コート上でもベンチでも存在感を発揮する（しかしメンバーからのレスポンスは無い。屍のようだ。）。試合中は良い場面でロングシュートを沈め、チームの起爆剤となる。'],
        ['渡合 広明','doai','Hiroaki Doai','','PG','大学4年生。キャリアコンサルティング研修生。NEXUS事業部。ポイントガードとして起用されることが多く、試合中には精度の高いフローターシュートと、息を飲むようなパスをさばく。トレードマークは爽やかな笑顔で、それらは皆、見る者を魅了する。']
    ];
    ...
    $managers = [
    	...
    	['拝野 恵里','haino','Eri Haino','','MANAGER','社会人1年目。しがく金子課長代理担当。バスケットボールは未経験ながら、ルールなどの知識を貪欲に吸収し、今では日本公認の審判ライセンスを持つ。チームでは動画の撮影、ベンチワーク、試合や練習のSNSへのアップロードなどをやって頂いている。また、キャリアバスケ部以外にもしがくの活動や、万祭の神話劇の実行委員や講師養成コースなど積極的に活動している。'],
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <span>
                                <h3 class="modal-title w-100" id="name"></h3>
                                <h3><small id="name-eng"></small></h3>
                            </span>
