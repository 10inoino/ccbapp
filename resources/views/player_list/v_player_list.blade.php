<?php
    ...
    $player_names = [
        ...
        ['佐藤 丈太郎','jo','Jotaro Sato','#18','C','社会人2年目。しがく山本主任担当。ペルーと日本のハーフで、ミドルネームはファビオ。190cmの身長を活かしたポストアップの他、ミドルレンジからシュート、ドライブと多彩なオフェンススキルを持つ。日本の3×3のリーグである、SOMECITYにも出場経験あり。サムネイルの写真は加工している訳では無いらしい（本人談）。彼女募集中。タイプは童顔。'],
