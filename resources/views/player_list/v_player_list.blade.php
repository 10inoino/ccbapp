<?php
    ...
    $player_names = [
    	['伊星 洵一郎','iboshi','Junichiro Iboshi','3','SG/SF','社会人1年目、しがく古谷さん担当。キャリアコンサルティングバスケットボール部のキャプテン。大学では武蔵野大学のバスケットボール部のキャプテンとしても活躍。持ち前のスピードとジャンプシュートでチームを勝利に導く。','png'],
        ['藤田 凌平','ryohei','Ryohei Fujita','6','PG/SG','大学4年生。長野県出身。ボールハンドリング、シューティング能力、フィジカルなどそれぞれのステータスにおいて比較的高い能力地を持つが、特にディフェンス','jpg'],
        ...
        ['金井 賢治','ken','Kenji Kanai','1','ALL ROUND','31歳、1人の愛娘を持つ父であり、2019年5月までB3の東京サンレーヴスでプレーをしていた元プロバスケットボール選手。大学時代は関東大学バスケットボールリーグ戦2部でアシスト王を獲得。190cmという長身ならではの力強いポストプレーは勿論のこと、繊細なドリブルや3ポイントシュートも狙うことができ、どこのポジションからでもゴールにアタックできる。','png'],
        ['山本 純也','yamamoto','Junya Yamamoto','0','PG/SG','NEXUS柳島さん担当。高校バスケ名門校の土浦日大高校出身。時には落ち着いたPGとしてチームの司令塔となり、時には持ち前のドライブとガッツで果敢にゴールにアタックする。','png']
    ];
